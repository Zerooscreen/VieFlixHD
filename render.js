...
const DEFAULT_TITLE = 'CineBox · Phim & Phim Bộ Thịnh Hành: Nội Dung, Đánh Giá, Diễn Viên & Trailer Đầy Đủ';
const DEFAULT_DESC = 'CineBox cung cấp nội dung phim, diễn viên, đánh giá và trailer chính thức của những phim và phim bộ phổ biến nhất hiện nay, kèm thông tin đầy đủ về mùa và tập phim.';
const DEFAULT_OG_IMAGE = 'https://placehold.co/1200x630/17171b/8d8a92?text=CineBox';

// TODO: điền mã xác minh Google Search Console CHO TÊN MIỀN NÀY
// (mã của cinebox-kr KHÔNG thể dùng lại ở đây -- nó gắn với tên miền khác).
...
// ---------- Adsterra & Histats ----------
// LƯU Ý: key/zone dưới đây GIỐNG với cinebox-kr/th/de/br/fr -> số liệu thống kê sẽ bị gộp chung.
// Nếu muốn tách riêng, hãy tạo zone mới trong Adsterra & Histats dành riêng cho tên miền này.
...
// Popunder CHỦ Ý KHÔNG kích hoạt (rủi ro bị Google coi là "intrusive interstitial" & trải nghiệm người dùng kém).
// Bỏ comment 3 dòng dưới + gọi popunderScript() trong layout() trước </body> nếu vẫn muốn dùng.
...
<footer>
  <p>CineBox — Trang thông tin phim và phim bộ sử dụng dữ liệu công khai từ TMDB (không phải dịch vụ xem phim trực tuyến) · Powered by <a href="https://www.themoviedb.org/" target="_blank" rel="noopener">TMDB</a></p>
  ${histatsSnippet()}
</footer>
